            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="flex-1">
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder="Search by name, email, phone, code, birth year..."
                    value={searchQuery}
              ...
              <div className="overflow-x-auto min-h-[400px]">
                <table className="w-full">
                  <thead className="bg-gray-50 border-b border-gray-100">
                    <tr>
                      <th className="px-3 py-2 sm:px-6 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Member</th>
                      <th className="hidden md:table-cell px-3 py-2 sm:px-6 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Contact</th>
                      <th className="hidden lg:table-cell px-3 py-2 sm:px-6 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Location</th>
                      <th className="px-3 py-2 sm:px-6 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Status</th>
                      <th className="px-3 py-2 sm:px-6 text-right text-xs font-semibold text-gray-500 uppercase tracking-wider">Actions</th>
                    </tr>
                  </thead>
                      ...
                      <tr key={member.id} className="hover:bg-gray-50 transition-colors">
                        <td className="px-3 py-2 sm:px-6 whitespace-nowrap">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <div className="font-medium text-gray-900 text-sm">{member.firstName} {member.lastName}</div>
                              <div className="text-[10px] text-gray-500">{member.fcsCode}</div>
                            </div>
                          </div>
                        </td>
                        <td className="hidden md:table-cell px-3 py-2 sm:px-6 whitespace-nowrap">
                        ...
                        <td className="hidden lg:table-cell px-3 py-2 sm:px-6 whitespace-nowrap">
                          {member.state && (
                            <div className="flex items-center gap-2 text-xs text-gray-600">
                        ...
                        <td className="px-3 py-2 sm:px-6 whitespace-nowrap">
                          <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium ${member.isActive
                          ...
                          <div className="flex items-center justify-end gap-2 relative">
                            ...
                            <div className="relative">
                              <button
                                ...
                                className={`p-1.5 rounded-lg transition-colors ${openMenuId === member.id ? 'bg-gray-100 text-gray-900' : 'text-gray-400 hover:text-gray-600 hover:bg-gray-100'}`}
                              >
                                <MoreVertical className="w-4 h-4" />
                              </button>
                              {/* Menu content omitted for brevity as it's not changing visually in the collapsed state */}
