      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div className="bg-white rounded-lg shadow py-2.5 px-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Total Groups</p>
                  <p className="text-xl font-black text-slate-700 mt-0">{groups.length}</p>
                </div>
            ...
            <div className="bg-white rounded-lg shadow py-2.5 px-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Total Members</p>
                  <p className="text-xl font-black text-green-600 mt-0">
            ...
            <div className="bg-white rounded-lg shadow py-2.5 px-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Avg Group Size</p>
                  <p className="text-xl font-black text-purple-600 mt-0">
                    {groups.length > 0
